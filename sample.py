...
# from app.models.program import User  # Commented out - User model not available
from app.models.facility import Product
# from werkzeug.security import generate_password_hash  # Commented out - not needed without User
...
def create_users_and_products():
    ...
    with app.app_context():
        # User creation commented out - User model not available
